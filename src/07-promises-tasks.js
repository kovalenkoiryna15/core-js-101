...
function willYouMarryMe(isPositiveAnswer) {
  return new Promise((resolve, reject) => {
    if (isPositiveAnswer === null
      || typeof isPositiveAnswer === 'undefined'
      || Number.isNaN(isPositiveAnswer)
      || typeof isPositiveAnswer === 'number'
      || typeof isPositiveAnswer === 'object'
      || typeof isPositiveAnswer === 'string') {
